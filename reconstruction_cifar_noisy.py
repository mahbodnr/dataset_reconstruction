...
x_paths = [
    r'C:\Users\Mahdi\Downloads\28000_x.pth',
...
print('ssims shape :', ssims.shape)
print('best 20 SSIMSs: ', torch.topk(ssims, 20))
print('Average best 20 SSIM: ', torch.mean(torch.topk(ssims, 20)[0]))



loss = torch.nn.MSELoss(reduction='none')
mse = loss(xx,yy).mean(dim=(1,2,3))
# print('total MSE: ', mse)
# print('best 20 MSE: ', torch.topk(mse, 20, largest=False))
loss = torch.nn.MSELoss()
mse = loss(xx,yy)
print('total MSE: ', mse)

lambda_paths = [
    r'C:\Users\Mahdi\Downloads\16000_l.pth',
#     './reconstructions/mnist_odd_even/rbijxft7_x.pth'
]

# Lambdas = torch.cat([torch.load(lambda_paths[0], map_location=torch.device('cpu'))])
# print(Lambdas.shape)

# print(torch.mean(Lambdas))