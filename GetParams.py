...
def get_args(*args):
    ...
    parser.add_argument(
        "--proj_name", default="", help="description of run, for saving stuff"
    )
    ...
    parser.add_argument(
        "--train_save_model_every", default=100000, type=int, help="only saves if >0"
    )
    parser.add_argument(
        "--extract_save_results", default="true", type=str2bool, help=""
    )
    parser.add_argument(
        "--extract_save_results_every", default=5000, type=int, help="only saves if >0"
    )
    parser.add_argument("--save_args_files", default="true", type=str2bool, help="")

    # wandb
    parser.add_argument(
        "--wandb_active", default="true", type=str2bool, help="actviate wandb logging"
    )
    ...
    parser.add_argument(
        ...
        default=1.0,
        type=float,
        help="percentage of noisy images in the dataset",
    )
    ...
    parser.add_argument(
        "--margin", default=12.0, type=float, help="training data margin"
    )
    parser.add_argument(
        "--extraction_data_amount_per_class",
        default=100,
        type=int,
        help="0 = same as data_amount",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--extraction_model_relu_alpha", default=149.86555429083975, type=float, help=""
    )
    parser.add_argument(
        "--extraction_init_scale", default=0.03497673778414215, type=float, help=""
    )
    parser.add_argument(
        "--extraction_lr", default=0.03052419903283405, type=float, help=""
    )
