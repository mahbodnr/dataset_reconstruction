...
def get_args(*args):
    ...
    parser.add_argument('--contrast_factor_1', default=0.1)
    parser.add_argument('--contrast_factor_2', default=0.6)
    ...
    parser.add_argument('--train_epochs', default=1000000, type=int, help='')
    parser.add_argument('--train_lr', default=0.01, type=float, help='')
    parser.add_argument('--train_evaluate_rate', default=300, type=int, help='')
    parser.add_argument('--train_threshold', default=1e-9, type=float, help='stop training below this loss')
